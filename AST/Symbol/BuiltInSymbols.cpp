...
AST::ptr_SymbolTable AST::genDefaultSymbolTable() {
	...
	def_table->add(definePattern("\"{x}\"",           "idbs",                tcast_desc, SymbolID::Function));
	def_table->add(definePattern("{x} as {y}",         nullptr,              tcast_desc, SymbolID::Function,  Precedence(TLH_PREC),            Precedence(TRH_PREC)));
	def_table->add(definePattern("{x} like {y}",       nullptr,              tcast_desc, SymbolID::Function,  Precedence(TLH_PREC),            Precedence(TRH_PREC)));
	...
	def_table->add(definePattern("output {x}",         "idbs",               sys_desc,   SymbolID::Function,  Precedence(SYS_PREC),            Precedence(SYS_PREC)));
...
AST::ptr_Symbol AST::definePattern(const char* header, const char* restrictions, const char* description, SymbolID pattern_type, Precedence p_lh, Precedence p_rh) {
